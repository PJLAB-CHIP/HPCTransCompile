...
void manual_unroll_avg_pool2d_cpu(
...
torch::Tensor manual_unroll_avg_pool2d_forward_cpu(
    torch::Tensor x,
    int kernel_size,
    int stride,
    int padding
    ...
    manual_unroll_avg_pool2d_cpu<scalar_t>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &manual_unroll_avg_pool2d_forward_cpu, "Manual Unroll 2D Average Pooling forward (CPU)");
}
