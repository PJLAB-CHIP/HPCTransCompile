...
torch::Tensor forward(
    ...
    conv_transpose2d_cpu<torch::scalar_t>(
        x.data_ptr<torch::scalar_t>(),
        weight.data_ptr<torch::scalar_t>(),
        (bias.has_value() && bias->defined()) ? bias->data_ptr<torch::scalar_t>() : nullptr,
        output.data_ptr<torch::scalar_t>(),
        batch_size,
        in_channels,
        in_height,
        in_width,
