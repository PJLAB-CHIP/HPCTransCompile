...
// CPU function for warp-level reduction
...
// CPU function for block-level reduction
...
// CPU kernel for matrix-vector multiplication
template <typename scalar_t>
void matvec_mul_kernel(
...
torch::Tensor matvec_mul_cpu(torch::Tensor A, torch::Tensor B) {
    TORCH_CHECK(A.is_cpu(), "A must be a CPU tensor");
    TORCH_CHECK(B.is_cpu(), "B must be a CPU tensor");
    ...
    AT_DISPATCH_FLOATING_TYPES(A.scalar_type(), "matvec_mul_cpu", ([&] {
